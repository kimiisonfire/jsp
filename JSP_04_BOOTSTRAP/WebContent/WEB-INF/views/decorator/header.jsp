  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <div class="row">
            <a class="col-md-8" href="javascript:OpenWindow('<%=request.getContextPath() %>/member/detail.do?id=${loginUser.id }','',800,600)" class="d-block">${loginUser.id}</a>
            <button class="btn btn-xs btn-default col-xs-3" type="button" onclick="javascript:location.href='<%=request.getContextPath()%>/commons/logout.do';" >Logout</button>
          </div>
