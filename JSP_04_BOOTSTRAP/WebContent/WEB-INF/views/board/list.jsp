    ...
    <section class="content">		
		<div class="card" >
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.do','Board | 글 등록', 800, 600);">글등록</button>				
				...
				<table class="table table-bordered text-center" >					
					...
					<c:forEach items="${dataMap.boardList }" var="board">
						<tr style='font-size:0.85em;'>
							...
							<a href="javascript:OpenWindow('detail.do${pageMaker.makeQuery(pageMaker.cri.page) }&bno=${board.bno }','board | 상세보기',800,600)">
